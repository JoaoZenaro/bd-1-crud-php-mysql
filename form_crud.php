...
if (isset($_POST['submit'])) {
    ...
    if (!isset($_POST['id_aluno'])) {
        ...
        if (!empty($_FILES['foto']['tmp_name']) || $estadoFoto) {
...
<body>
    <div class="container my-2 col" id="crud">
        ...
        <form class="was-validated" id="form" class="row gx-3 gy-0" method="post" enctype="multipart/form-data">
            ...
            <div class="form-floating mb-2">
                <input type="date" name="nascimento" id="iNascimento" class="form-control"
                    value="<?= $nascimento ?>" placeholder="Data de nascimento" required />
